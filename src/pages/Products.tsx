          ...
          <table className="w-full text-right border-collapse min-w-[1000px]">
            <thead className="bg-slate-50 text-slate-500 text-[11px] uppercase tracking-wider sticky top-0 z-10">
              <tr className="border-b border-slate-200">
                <th className="px-6 py-3 font-semibold text-center w-16">
                  وێنە
                </th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-mono">
                      <div className="text-slate-600">
                        {formatCurrency(pCost, product.currency)}
                      </div>
                    ...
                    <td className="px-6 py-4 font-mono">
                      <div className="text-slate-900">
                        {formatCurrency(pPrice, product.currency)}
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 font-mono">
                      <div className="text-green-600 font-bold">
                        +{formatCurrency(profitPerUnit, product.currency)}
                      </div>
                      {profitPerWholesale !== null && (
                        <div className="text-xs text-green-500 font-bold mt-1">
                          +
                          {formatCurrency(profitPerWholesale, product.currency)}
                        </div>
                      )}
                    </td>
                    <td className="px-6 py-4">
                      ...
                      >
                        {product.cartonSize && product.cartonSize > 1 ? (
                          <>
                            ...
                            {pStock % product.cartonSize !== 0 &&
                              ` و ${pStock % product.cartonSize} دانە`}
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          ...
          >
                ...
                <div className="col-span-1 sm:col-span-2">
                  <div className="bg-indigo-50/50 border-2 border-indigo-100 rounded-2xl p-4">
                    <h4 className="text-sm font-bold text-indigo-900 mb-4 flex items-center gap-2">
                      ...
                      ڕێکخستنی ستۆک و بڕی بەردەست
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs font-bold text-slate-600 mb-1.5">
                          دانە لەناو یەک کارتۆن
                        </label>
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-white border border-indigo-200 rounded-xl p-2.5 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-left transition-colors"
                            dir="ltr"
                          />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-white border border-indigo-200 rounded-xl p-2.5 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-left transition-colors text-indigo-700 font-bold"
                            dir="ltr"
                          />
                          <div className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-indigo-400 pointer-events-none">
                            کارتۆن
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              const cSize = parseInt(cartonSize, 10) || 1;
                              const cVal = Math.floor(
                                (parseInt(stock, 10) || 0) / cSize,
                              );
                              setStock((cVal * cSize + pVal).toString());
                            }}
                            className="w-full bg-white border border-indigo-200 rounded-xl p-2.5 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-left transition-colors text-indigo-700 font-bold"
                    ...
                    <div className="mt-4 pt-4 border-t border-indigo-100 flex items-center justify-between">
                      <div className="text-xs text-indigo-600 font-bold">
                        کۆی گشتی ستۆک بە دانە:
                      </div>
                      <div className="text-xl font-black font-mono text-indigo-900 bg-white px-4 py-1 rounded-lg border border-indigo-100 shadow-sm">
                        {stock || 0}
                      </div>
                    </div>
                  </div>
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-pink-600 text-white hover:bg-pink-700 rounded-lg text-sm font-medium transition-colors"
              >
                پاشەکەوتکردن
              </button>
            </div>
